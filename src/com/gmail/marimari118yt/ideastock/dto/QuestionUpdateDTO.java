...
public class QuestionUpdateDTO {
	...
	public QuestionUpdateDTO id(int id) {
		this.id = id;
		return this;
	}

	public QuestionUpdateDTO authorId(int authorId) {
		this.authorId = authorId;
		return this;
	}

	public QuestionUpdateDTO title(String title) {
		this.title = title;
		return this;
	}

	public QuestionUpdateDTO content(String content) {
